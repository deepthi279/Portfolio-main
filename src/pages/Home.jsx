...
// //     <section
// //       id="home"
// //       className="flex flex-col md:flex-row items-center justify-between p-8 md:p-16 min-h-screen bg-white dark:bg-gradient-to-br dark:from-[#0d0d0d] dark:to-[#1a1a1a] transition-colors duration-500"
// //     >
// //       {/* Left Content */}
// //       <div className="md:w-1/2 space-y-6 text-center md:text-left">
// //         {/* Animated Badge */}
// //         <div
// //           className="inline-block px-3 py-1 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-full text-sm mb-2 animate-bounce"
// //         >
// //           Hey there! 👋 I'm
// //         </div>

// //         {/* Name */}
// //         <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-transparent bg-clip-text break-words">
// //           Deepthi Salunkey
// //         </h1>

// //         {/* Typing Subtitle */}
// //         <div className="text-lg md:text-xl font-semibold text-pink-500 dark:text-pink-400 break-words h-8">
// //           <Typewriter
// //             words={[
// //               "Frontend Developer",
// //               "React.js Specialist",
...
// //           Passionate about crafting elegant, high-performing web applications that deliver delightful user experiences. I thrive on solving complex problems and bringing ideas to life through clean, scalable code.
// //         </p>
...
// //             <span
// //               key={tech}
// //               className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-2 py-1 rounded-full animate-fadeIn"
// //             >
// //               {tech}
// //             </span>
// //           ))}
...
// //             className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition transform hover:scale-105"
// //           >
// //             📄 View Resume
// //           </a>
// //           <a
// //             href="#contact"
// //             className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 transition transform hover:scale-105"
// //           >
// //             ✉️ Contact Me
// //           </a>
// //         </div>
...
// //             target="_blank"
// //             rel="noopener noreferrer"
// //             className="text-gray-600 dark:text-slate-400 hover:text-blue-500 text-2xl transition transform hover:scale-125"
// //           >
// //             <FaLinkedin />
// //           </a>
// //           <a
// //             href="mailto:deepthisalunkey996@gmail.com"
// //             className="text-gray-600 dark:text-slate-400 hover:text-pink-500 text-2xl transition transform hover:scale-125"
// //           >
// //             <FaEnvelope />
// //           </a>
// //         </div>
...
// //           className="rounded-full w-64 h-64 object-cover border-4 border-purple-500 shadow-lg hover:scale-105 transform transition duration-500"
// //         />
// //       </div>
// //     </section>
// //   );
...
//       <div className="md:w-1/2 space-y-6 text-center md:text-left">
//         {/* Animated Badge */}
//         <div className="inline-block px-4 py-1 bg-blue-200 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full text-sm font-medium animate-pulse shadow">
//           👋 Hey there! I'm
//         </div>

//         {/* Name */}
//         <h1
//       className="text-5xl sm:text-6xl font-extrabold text-center bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent"
//     style={{
//       paddingBottom: '16px',
//       lineHeight: '1.3',
...
//         {/* Subtitle Typing */}
//         {/* <div className="text-lg md:text-xl font-semibold text-blue-600 dark:text-blue-300 h-8 animate-fadeIn"> */}
...
//           Passionate about crafting elegant, performant web applications. I bring designs to life through scalable code and clean architecture.
//         </p>

//         {/* Tech Tags */}
//         <div className="flex flex-wrap gap-2 mt-4 justify-center md:justify-start">
//           {[
//             "React.js", "Vue.js", "Angular", "Tailwind CSS",
//             "Django", "Node.js", "AWS"
//           ].map((tech) => (
//             <span
//               key={tech}
...
//         {/* CTA */}
//         <p className="mt-6 text-base text-gray-700 dark:text-gray-400 max-w-md animate-fadeInUp">
//           💡 Open to freelance projects and collaboration opportunities. Let’s build something amazing together!
//         </p>
//       </div>
